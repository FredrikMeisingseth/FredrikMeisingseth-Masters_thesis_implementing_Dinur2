...
void rbfunc_print_map(rbfunc_t *rbfunc);
...
/* Compute the Möbius (zeta) transform of in the set W_{w}^{n} 'rbfunc' using Yate's algorithm and
 * overwriting 'rbfunc' with the result. */
void rbfunc_moebius_transform(rbfunc_t *rbfunc);
